...
| execution-runner | resource | Definition | project://peer2paper/execution/runner.py | dispatch | file | Project-owned versioned scientific execution runner used by reproduction, robustness, and independent statistical verification. A missing runner file blocks execution. |
