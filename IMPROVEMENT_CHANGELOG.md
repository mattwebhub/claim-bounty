...
- Public evidence path: [human baseline](docs/HUMAN_BASELINE.md), [usage accounting](docs/USAGE_AND_COST.md), [trajectory index](workflow/claimbounty-scientific-audit/trajectories/index.json), [trajectory sanitization policy](workflow/claimbounty-scientific-audit/trajectories/sanitization-policy.md), [Peer2Paper product guide](submission/reviewer/peer2paper-product-guide.pdf), and [public-release check](scripts/check-public-release).
